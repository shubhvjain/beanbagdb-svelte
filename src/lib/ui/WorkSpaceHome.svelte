  ...
  const all_pages = [
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
...
<!-- 
      ...
      <div class="list-group">
        {#each all_pages as pg}
          ...
          >
            <i class="m-2"> {@html pg.icon} </i> {pg.text}</button
          >
        {/each}
      </div>
    </div>
